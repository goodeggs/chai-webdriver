...
var addSizzle, fs, seleniumWebdriver, sizzleCode, uglify;
  ...
  return function(chai, utils) {
    ...
    assertElementExists = function(selector, done) {
      return findElementsByCss(selector).then(function(els) {
        if (els.length === 0) {
          return takeScreenshot("" + (string(selector).slugify()) + ".png", function() {
    ...
    return chai.Assertion.addMethod('value', function(value, done) {
      var _this = this;
      if (!utils.flag(this, 'dom')) {
