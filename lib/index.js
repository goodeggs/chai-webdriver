...
var chaiWebdriver, fs, injectSizzle, seleniumWebdriver, sizzleCode, string, uglify;
...
injectSizzle = function(driver) {
  if (driver.executeScript(function() {
...
module.exports = chaiWebdriver = function(driver) {
  var findElementByCss, findElementsByCss, get;
  get = driver.get;
  driver.get = function() {
    return get.apply(driver, arguments).then(function() {
      return injectSizzle(driver);
    });
  };
  ...
  return function(chai, utils) {
    ...
    return chai.Assertion.addMethod('htmlClass', function(value, done) {
      var _this = this;
      if (!utils.flag(this, 'dom')) {
        throw new Error('Can only test value of dom elements');
      }
      return assertElementExists(this._obj, function() {
        return findElementByCss(_this._obj).getAttribute('class').then(function(classList) {
